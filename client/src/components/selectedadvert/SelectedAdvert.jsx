  ...
  contentForAll = () => {
    return (
      <div className="container mt-3">
        <Helmet>
          <title>
            Real Estate{this.props.advert.isForRent?" for rent ":" for sale"}{this.props.advert.city?`${this.props.advert.city}`:" Kenya"} 
          </title>
          {/* <link rel="canonical" href="http://mysite.com/example" /> */}
          <meta name="description" content={`Real Estate${this.props.advert.isForRent?" for rent":" for sale"}${this.props.advert.city?` ${this.props.advert.city}`:" Kenya"}${this.props.advert.address?` ${this.props.advert.address}`:""}${this.props.advert.postcode?`, ${this.props.advert.postcode}`:""}`} />
